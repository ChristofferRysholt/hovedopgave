...
class Article
{
  ...
  */
  ...
  public function __construct( $data=array() ) {
    ...
    if (isset($data['title'])) $this->title = preg_replace ("/[^\.\,\-\_\'\"\@\?\!\:\$ a-zA-Z0-9()]\æ\ø\å\Æ\Ø\Å/", "", $data['title']);
    if (isset($data['summary'])) $this->summary = preg_replace ("/[^\.\,\-\_\'\"\@\?\!\:\$ a-zA-Z0-9()]\æ\ø\å\Æ\Ø\Å/", "", $data['summary']);
